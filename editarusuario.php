    ...
    try{
        if(isset($_GET['id'])){
            ...
            if(count($usuarios)==1) {
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form name="cadastro" action="atualizarusuario.php" method="post" class="needs-validation" novalidate>
                ...
                echo "<div class='alert alert-warning'>Usuário não encontrado. <a href='listausuarios.php' class='alert-link'>Voltar para a listagem</a></div>";
            }
        } else {
            echo "<div class='alert alert-warning'>Selecione um registro. <a href='listausuarios.php' class='alert-link'>Voltar para a listagem</a></div>";
        }
